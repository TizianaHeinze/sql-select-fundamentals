...
-- SELECT * puede ser útil para explorar una tabla durante el análisis.
-- En producción no es recomendable porque puede traer columnas innecesarias,
-- consumir más recursos y hacer más difícil mantener las consultas.
